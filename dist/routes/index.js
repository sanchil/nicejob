...
router.route('/').get(controllers.basicContrl, lib.writeRedisCache(cachebool, cache_expire));

router.route('/health').get(controllers.healthReportCtrl);

router.route('/:collection/:id').get(controllers.readOneCtrl, lib.writeRedisCache(cachebool, cache_expire)).post(controllers.updateDocCtrl).delete(controllers.deleteDocCtrl);

router.route('/:collection').get(controllers.readManyCtrl, lib.writeRedisCache(cachebool, cache_expire)).post(controllers.writeCtrl);
